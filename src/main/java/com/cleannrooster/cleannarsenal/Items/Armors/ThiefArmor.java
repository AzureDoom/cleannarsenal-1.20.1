...
import com.cleannrooster.cleannarsenal.client.item.renderer.ThiefArmorRenderer;
...
public class ThiefArmor extends CustomArmor implements GeoItem {


    public ThiefArmor(Armor.CustomMaterial material, Type type, Settings settings) {
    ...
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            private ThiefArmorRenderer renderer;

            @Override
            public BipedEntityModel<LivingEntity> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, BipedEntityModel<LivingEntity> original) {
                if (this.renderer == null) {
                    this.renderer = new ThiefArmorRenderer();
                }
